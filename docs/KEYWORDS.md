# OKW Web Selenium – KEYWORDS

Diese Datei fasst die in den beigefügten Doku-Seiten beschriebenen Keywords zusammen und dient als **Contract-Referenz**
für `robotframework-okw-web-selenium`.

> Ziel: **technik-unabhängige Keywords**, konkrete Umsetzung via **Selenium WebDriver Adapter**.
