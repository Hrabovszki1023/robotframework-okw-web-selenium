# OKW Web Selenium – Prompt Guide für KI (Codex)
...
## Contract-Regeln (wichtig)

- Verwende **ausschließlich** Keywords, die in `docs/KEYWORDS.md` stehen.
- Ändere **keine** Keyword-Namen und erfinde keine neuen.
- Keyword-Semantik ist in `docs/SPECIFICATION.md` definiert.
- Der Contract ist technisch abgesichert durch `tests/contract/contract.robot`.
